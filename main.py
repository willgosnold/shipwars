...
BULLET_FIRE_SOUND = pygame.mixer.Sound(
    os.path.join("Assets", "GunSilencer.mp3"))
...
def draw_window(yellow, red, yellow_bullets,
...
def main():
    yellow = pygame.Rect(150, 300, SPACESHIP_HEIGHT, SPACESHIP_WIDTH)
    red = pygame.Rect(750, 300, SPACESHIP_HEIGHT, SPACESHIP_WIDTH)
    yellow_bullets = []
    red_bullets = []
    yellow_health = 10
    red_health = 10
